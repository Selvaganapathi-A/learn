...
def PrimeDecorator(myfunc: Callable[..., Any]) -> Callable[..., Any]:
...
def AlphaDecorator(myfunc: Callable[..., Any]) -> Callable[..., Any]:
    def AlphaWrapper(*args: Iterable[Any], **kwargs: Mapping[Any, Any]):
